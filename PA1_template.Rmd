...
```
The average number of steps taken is `r avg`.

The median number of steps taken is `r med`.
...
The interval with the maximum number of average steps is number `r top_interval`, with an average of `r top_steps` steps.
...
mcount <- nrow(missing)
```
The total number of rows with missing data is `r mcount`.
...
```
The average number of steps taken is `r avg_imp`.

The median number of steps taken is `r med_imp`.
